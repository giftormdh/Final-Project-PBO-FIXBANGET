...
namespace Final_Project_PBO_1.Controller
{
    internal class ProductController
    {
        ...
        public void PostProductHistory(string name, string borrowState)
        {
            SendProductHistory PH = new SendProductHistory();

            PH.Name = name;
            PH.borrowState= borrowState;

            var CheckOutItemsJson = JsonConvert.SerializeObject(PH);
